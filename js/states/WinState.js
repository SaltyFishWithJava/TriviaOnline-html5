...
Trivia.WinState = function () {
    "use strict";
    Trivia.BaseState.call(this);
};

Trivia.WinState.prototype = Object.create(Trivia.BaseState.prototype);
Trivia.WinState.prototype.constructor = Trivia.WinState;

Trivia.WinState.prototype.create = function () {
    "use strict";
...
Trivia.WinState.prototype.restart = function () {
